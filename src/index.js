...
class HourlyRate extends React.Component
{
	...
	onChangeForInput(value, typeOfInput)
	{
		...
		this.setState({inputValueArray: newInputValueArray, hourlyRateArray: tempHourlyRateArray});
	}
...
class PageManager extends React.Component
{
	...
	render()
	{
		...
		if(this.state.whatRendersNext === "isInteroperabilityNext")
			return (<YesNoQuestion updateParentState = {this.updateStateCB}  feeArray = {this.state.feeArray} whatRendersNextOnYes = "isVettingProcessNext" whatRendersNextOnNo = "isHandleIntegrationsNext"
		...
		if(this.state.whatRendersNext === "isVendorIntegrationNext" )
			return (<Integration hourlyRateArray = {this.state.hourlyRateArray} feeArray = {this.state.feeArray} integrationType = {"Vendor"} systemPairing = {this.state.systemPairing}/>)


		if(this.state.whatRendersNext === "isConsultantIntegrationNext")
			return <Integration hourlyRateArray = {this.state.hourlyRateArray} feeArray ={this.state.feeArray} integrationType = {"Consultant"} systemPairing = {this.state.systemPairing}/>

		if(this.state.whatRendersNext === "isCustomIntegrationNext")
			return <Integration hourlyRateArray = {this.state.hourlyRateArray} feeArray ={this.state.feeArray} integrationType = {"Custom"} systemPairing = {this.state.systemPairing}/>
